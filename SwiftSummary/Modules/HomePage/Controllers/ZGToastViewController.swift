//
//  ZGToastViewController.swift
//  SwiftSummary
//
//  Created by jing_mac on 2020/4/27.
//  Copyright © 2020 jing_mac. All rights reserved.
//

import UIKit

class ZGToastViewController: UITableViewController {
...
extension ZGToastViewController {
        ...
        if indexPath.section == 0 {
            ...
            if indexPath.row == 0 {
                if cell == nil {
                    ...
                    tapToDismissSwitch.addTarget(self, action: #selector(handleTapToDismissToggled), for: .valueChanged)
                ...
                if cell == nil {
                    ...
                    queueSwitch.addTarget(self, action: #selector(handleQueueToggled), for: .valueChanged)
